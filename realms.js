module.exports = function(){
    ...
    function getRealms(res, mysql, context, complete){
        mysql.pool.query("SELECT R.name as name, COUNT(P.id) as planet_count FROM realms R INNER JOIN planets P ON P.realm=R.id ORDER BY R.name ASC", function(error, results, fields){
            if(error){
