module.exports = function(){
    ...
    function getRealms(res, mysql, context, complete){
        mysql.pool.query("SELECT R.name, COUNT(P.name) as planet_count FROM realms R LEFT JOIN planets P ON P.realm=R.id WHERE P.realm IS NOT NULL GROUP BY R.name ASC", function(error, results, fields){
            if(error){
